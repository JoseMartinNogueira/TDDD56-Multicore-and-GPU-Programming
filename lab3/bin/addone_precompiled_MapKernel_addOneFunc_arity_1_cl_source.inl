...
__kernel void addone_precompiled_MapKernel_addOneFunc_arity_1(__global float *a,  __global float* output, size_t w, size_t n, size_t base)
{
	...
	(
		...
		skepu2::backend::DeviceMemPointer_CL<float> *a,  skepu2::backend::DeviceMemPointer_CL<float> *output,
		size_t w, size_t n, size_t base
	)
	{
		skepu2::backend::cl_helpers::setKernelArgs(kernels(deviceID), a->getDeviceDataPointer(),  output->getDeviceDataPointer(), w, n, base);
